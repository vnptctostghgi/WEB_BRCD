...
def test_feature_path_opens_current_app_shell() -> None:
    with TestClient(app) as client:
        ...
        assert "/static/app.js?v=181" in public_response.text
        assert "/static/styles.css?v=120" in public_response.text
        public_js = client.get("/static/app.js?v=181")
...
def test_viewer_cannot_access_dashboard_builder_api_or_report_runner() -> None:
    with TestClient(app) as client:
        ...
        assert "/static/shell.js?v=6" in home.text
        assert "/static/app.js?v=181" not in home.text
        shell_js = client.get("/static/shell.js?v=6")
        ...
        assert "/static/app.js?v=181" in shell_js.text
        ...
        assert "/static/app.js?v=181" in reports.text
        ...
        assert "/static/app.js?v=181" in workstation.text
        ...
        assert "/static/app.js?v=181" in work_tasks.text
        ...
        assert "/static/app.js?v=181" in report_links.text
        ...
        assert "/static/app.js?v=181" in system.text
        ...
        assert "/static/app.js?v=181" in onebss_mining.text
